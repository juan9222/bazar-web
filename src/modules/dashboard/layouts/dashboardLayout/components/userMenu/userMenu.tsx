          ...
          >
            ...
            <div className="dshLayout__body--header--user--dropdown--listMenu">
              <ListGroup variant="flush">
                ...
                <ListGroupItem action onClick={ () => { window.open('https://www.bazar.network/creation-user-seller', '_blank');; } } className="dshLayout__body--header--user--dropdown--listMenu--item">
